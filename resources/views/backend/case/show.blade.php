		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="nav-tabs-custom">
		            <ul id="case_details_tab_list" class="nav nav-tabs">
		              <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Case Summery</a></li>
		              <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Field Agent - Case Info</a></li>
		              <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">Helpdesk - Case Info</a></li>
		              <li class=""><a href="#tab_4" data-toggle="tab" aria-expanded="false">Fact Finding - Case Info</a></li>
		              <li class=""><a href="#tab_5" data-toggle="tab" aria-expanded="false">Admin - Case Info</a></li>
		              <li class=""><a href="#tab_6" data-toggle="tab" aria-expanded="false">Message Box</a></li>
            							...
            							<div class="box-body table-responsive">
            							  <table class="table table-bordered table-condesed">
            							    <tbody>
            							    	...
            							    	<tr>
            							    	  <td><span class=""><strong>Types of Violence</strong></span></td>
            							    	  <td><span class="text-red">{{ $violence_type[$cases->case_type] or '' }}</span></td>
            							    	</tr>
            							       
            							        <tr>
            							          <td><span class=""><strong>Case Status</strong></span></td>

            							          	@if( $cases->case_status == 'open' )
					          							<td><span class="label label-warning">{{ $cases->case_status }}</span></td>
					          						@elseif( $cases->case_status == 'approve' )
					          							<td><span class="label label-success">{{ $cases->case_status }}</span></td>
					          						@elseif( $cases->case_status == 'archive' )
            							        ...
            							        <tr>
            							        	<td><strong>Case Created By</strong></td>
										...
										<div class="box-body ">
											...
											<div class="box_body_section">
												...
												<div class="box_body_section_content">
													...
													<p>{{ str_pad($cases->casevictim[0]->id, 4, '0', STR_PAD_LEFT) or '' }}</p>
											...
											<div class="box_body_section">
												<h4>Parents</h4>
												<div class="box_body_section_content">
													<p>{{ $cases->casevictim[0]->parents }}</p>
												</div>
											</div>
											...
											<div class="box_body_section">
												<h4>Location</h4>
												<div class="box_body_section_content">
													<p>{{ $cases->casevictim[0]->location }}</p>
												</div>
											</div>
		              	...
		              	<div class="tab-pane" id="tab_2">
		                	...
		                	<div class="row">
		                		<div class="col-xs-7">
            						<div class="box">
            							<div class="box-header">
            								<h3>Additinal Case Information by Field Agent</h3>
            								<div class="pull-left">
            									<!-- <a id="add-button" title="Add New" class="btn btn-success" href="{{ route('backend.case.create') }}"><i class="fa fa-plus-circle"></i> Add New</a> -->
            								</div>
            								<div class="pull-right">
            							...
            							<div class="box-body table-responsive">
            							  <table class="table table-bordered table-condesed">
            							    <tbody>
            									...
            									<tr>
            							    	  	<td><span class=""><strong>Immediate Action by F.A</strong></span></td>
            							    	  	<td>
														@php
															$cases_actions = json_decode($cases->action_taken);	
														@endphp
														
														@if( !empty($cases_actions) && is_array($cases_actions) )
															<ul>
																@foreach($cases_actions as $key => $value)

																	<li>{{ $action_taken[$value] or '' }}</li>	

																@endforeach
															</ul>
														@else
															<span>{{ $action_taken[$cases->action_taken] or '' }}</span>
														@endif
		                		...
		                		<div class="col-xs-5">
            						<div class="box">
            							...
            							<div class="box-body table-responsive">
            								...
            								{{--@if( isset($cases_meta['fa_field_normal']) )
            								<div class="normal_field_fa">
            									<ul class="clearfix list-style-none">
            										
            										@foreach( $cases_meta['fa_field_normal'] as $value )
           				            		...
           				            		<div id="hd_show_case_info" class="hd_show_case_info" data-counthd="0">
           				            			...
           				            			<div class="single_hd_show_case_info">
           											...
           											<div class="case_info_hd_all">
           												<h4 class="m_bottom_15">Case info by HD Team</h4>
		              	...
		              	<div class="tab-pane" id="tab_4">
		               		<div class="row">
		               			<div class="col-xs-12">
           				            ...
           				            <div class="box">
           				            	<div class="box-header">
           				            		<h3>Additional case information by Fact Finding Team</h3>
           				            		<div class="pull-left">
           				            			<!-- <a id="add-button" title="Add New" class="btn btn-success" href="#"><i class="fa fa-plus-circle"></i> Add New</a> -->
           				            		</div>
           				            		<div class="pull-right">
           				            		...
           				            		<div id="ff_show_case_info" class="ff_show_case_info" data-countadmin="0">
           				            			...
           				            			<div class="single_ff_show_case_info">
           											...
           											<div class="case_info_ff_all">
           												<h4 class="m_bottom_15">Case info by FF</h4>
		              	...
		              	<div class="tab-pane" id="tab_5">
		               		<div class="row">
		               			<div class="col-xs-12">
           				            ...
           				            <div class="box">
           				            	<div class="box-header">
           				            		<h3>Additional case information by Admin</h3>
           				            		<div class="pull-left">
           				            			<!-- <a id="add-button" title="Add New" class="btn btn-success" href=""><i class="fa fa-plus-circle"></i> Add New</a> -->
           				            		</div>
           				            		<div class="pull-right">
           				            		...
           				            		<div id="admin_show_case_info" class="admin_show_case_info" data-countadmin="0">
           				            			...
           				            			<div class="single_admin_show_case_info">
           											...
           											<div class="case_info_admin_all">
           												<h4 class="m_bottom_15">Case info by Admin</h4>
